...
<body>
	...
	<div class="text-center p-1">
		<a href="users.php">
			<button class="mx-auto m-1 btn-sm btn btn-primary text-white">All Users</button>
		</a>
	</div>
	...
	<?php if(!empty($row)):?>
		<div class="row col-lg-8 border rounded mx-auto mt-5 p-2 shadow-lg">
			<div class="col-md-4 text-center">
				...
				<button class="mx-auto m-1 btn-sm btn text-white">
				<div class="heart-btn">
    		  		<div class="content">
    		  			<span class="heart"></span>
        				<span class="text"><i class="fas fa-heart icon"></i>Like</span>
